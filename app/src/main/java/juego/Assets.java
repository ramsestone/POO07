...
/**
 * Clase centralizada para la gestión de rutas de recursos.
 * Evita la dispersión de strings en el código.
 */
public final class Assets {
    ...
    public static final Imagen JUGADOR = new Imagen(BASE_PATH + "nave_rebelde.png");
    public static final Imagen FONDO = new Imagen(BASE_PATH + "background_blue.png");
