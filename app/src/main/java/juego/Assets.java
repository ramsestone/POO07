...
public final class Assets {
  ...
  public static final String DESTRUCTOR_NEGATIVO = BASE_PATH + "destructor_negativo.png";


  public static final String AVE_DE_PRESA = BASE_PATH + "ave_de_presa.png";
  public static final String AVE_DE_PRESA_NEGATIVA = BASE_PATH + "ave_de_presa_negative.png";

  public static final String LANZA_MINAS = BASE_PATH + "lanza_minas.png";
  public static final String LANZA_MINAS_NEGATIVO = BASE_PATH + "lanza_minas_negativo.png";
